(function () {
  var canvas = document.getElementById('hero-hills-canvas');
  ...
  var mesh = new THREE.Mesh(
    ...
    new THREE.RawShaderMaterial({
      ...
      fragmentShader: [
        ...
        'varying vec3 vPosition;',
        'void main(void){',
        /* Zenxian cyan: #32C8D9 = rgb(50,200,217) */
        '  float opacity=(96.-length(vPosition))/256.*0.55;',
        '  vec3 color=vec3(0.196,0.784,0.851);',
