   ...
   services: [
    {
     ...
     featureCards: [
      { icon: '◈', title: 'How It Looks & Feels', desc: 'Your website will be clean, easy to navigate, and built to make a great first impression' },
      { icon: '⬡', title: 'Works on Every Device', desc: 'Loads fast and looks great on phones, tablets, and desktops' },
      { icon: '⬢', title: 'Everything Behind the Scenes', desc: 'All the invisible systems that store your data, process orders, and keep things running' },
      { icon: '◈', title: 'Connected to Your Tools', desc: 'We link your website to the apps and services you already use like payments, bookings, or CRMs' },
      { icon: '⬡', title: 'Safe & Reliable', desc: 'Your site stays protected, available 24/7, and running at full speed' },
      { icon: '⬢', title: 'We Stay with You', desc: 'After launch, we keep everything updated, fix any issues, and support you as you grow' }
     ],
     modernFeatures: [
     ...
     closingLine: 'We combine strategy, design, and technology to deliver web solutions that look great, perform at scale, and deliver real results.'
    },
    {
     ...
     benefits: [
      { title: 'Business-Focused Approach', desc: 'We focus on practical AI solutions that deliver real results, not just follow trends.' },
     ...
     featureCards: [
      { icon: '◈', title: 'Find Where AI Helps You', desc: 'We look at your business and show you exactly where AI can save time and make money' },
      { icon: '⬡', title: 'Stop Doing Repetitive Work', desc: 'We automate the tasks your team does manually every day, so they can focus on what matters' },
      { icon: '⬢', title: 'Understand Your Own Data', desc: 'We turn the numbers and records you already have into clear answers you can act on' },
      { icon: '◈', title: 'AI Built for Your Business', desc: 'We build smart tools designed around how your business actually works, not generic software' },
      { icon: '⬡', title: 'Works with What You Have', desc: 'We connect AI into the tools and systems you already use, no need to start from scratch' },
      { icon: '⬢', title: 'We Stay by Your Side', desc: 'We guide you as your business grows and help you get more out of AI over time' }
     ],
     modernFeatures: [
    ...
    },
    {
     ...
     featureCards: [
      { icon: '◈', title: 'Find What Your Customers Search', desc: 'We discover the exact words your potential customers type into Google so your business shows up first' },
      { icon: '⬡', title: 'Make Your Website Easy to Find', desc: 'We update your website content and layout so search engines understand what you offer' },
      { icon: '⬢', title: 'Fix What Slows You Down', desc: 'We speed up your site, make it work well on phones, and fix hidden issues that hurt your rankings' },
      { icon: '◈', title: 'Write Content That Ranks', desc: 'We create and improve your website text so more people find you and stay on your site longer' },
      { icon: '⬡', title: 'Track Your Growth', desc: 'We show you clear reports on how your rankings are improving and what we are doing to keep them going up' }
     ],
     modernFeatures: [
    ...
    },
    {
     ...
     featureCards: [
      { icon: '◈', title: 'Your Own Online Shop', desc: 'We build a store that looks and works exactly the way your business needs, not a generic template' },
      { icon: '⬡', title: 'Manage Your Products Easily', desc: 'Add, update, and track your products and stock without any technical knowledge' },
      { icon: '⬢', title: 'Get Paid Safely Online', desc: 'We set up trusted payment methods so your customers can pay with confidence' },
      { icon: '◈', title: 'Make Buying Simple', desc: 'We design a smooth shopping experience so more visitors actually complete their purchase' },
      { icon: '⬡', title: 'See How Your Store is Doing', desc: 'A simple dashboard shows your sales, popular products, and customer activity in one place' }
     ],
     modernFeatures: [
     ...
     closingLine: 'We build e-commerce platforms that look great, drive sales, improve operations, and help your business grow continuously!'
    }
   ]
  },
